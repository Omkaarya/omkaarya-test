  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-zinc-900 dark:text-white tracking-tight">Internal Chat</h1>
          <p className="text-zinc-500 dark:text-zinc-400 font-medium mt-1">
            Communicate with temple staff and groups.
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 p-8 text-center shadow-sm">
        ...
        <p className="text-zinc-500 mt-2 max-w-md mx-auto">
          The chat module will feature 1:1 messaging, group channels, and file sharing based on your active plan.
        </p>
      </div>
    </div>
  );
