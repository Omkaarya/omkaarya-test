      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="space-y-6">
           <div>
              ...
              <p className="text-[11px] text-zinc-400 mt-5 leading-relaxed font-medium text-center italic">This logo will appear on all printed receipts and official documents.</p>
           </div>
        </div>
