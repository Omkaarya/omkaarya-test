      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-800 pb-10">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400 font-medium mt-1">
            Configure global currency metrics, tax rates, and fiscal year
            settings.
          </p>
        </div>
        <Button
      ...
      <div className="space-y-12">
        ...
        <div>
          <h4 className="text-sm font-bold text-[var(--text-primary)] mb-3 flex items-center gap-1.5">
            <Wallet className="w-4 h-4 text-zinc-400" /> Base Metrics
          </h4>
            ...
            <div className="space-y-6 animate-in slide-in-from-top-4 duration-500">
              ...
              <div className="p-6 rounded-[24px] bg-amber-50/50 dark:bg-amber-950/10 border border-amber-100 dark:border-amber-900/30">
                <div className="flex gap-3">
                  ...
                  <div>
                    <h4 className="text-[11px] font-black text-amber-900 dark:text-amber-200 uppercase tracking-tight">
                      Cumulative Taxation
                    </h4>
                    <p className="text-[11px] font-medium text-amber-700/70 dark:text-amber-400/70 mt-1 leading-relaxed">
                      Taxes will be calculated cumulatively on the subtotal.
                      Ensure your legal entity status in Sri Lanka matches these
                      rates for compliance audit.
                    </p>
                  </div>
                </div>
              </div>
