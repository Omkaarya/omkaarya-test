...
const SUPPLIERS_DATA = [
  { id: "S-101", name: "Srinivasa Flower Traders", type: "Flowers & Garlands", onboard: "12 Mar 2024", email: "contact@srinivasaflowers.lk", phone: "+94 77 123 4567", status: "Active" },
  { id: "S-102", name: "Omkara Pooja Samagiri", type: "Pooja Items", onboard: "15 Mar 2024", email: "orders@omkarapooja.lk", phone: "+94 71 987 6543", status: "Active" },
  { id: "S-103", name: "Lanka Dairy Co.", type: "Milk & Ghee", onboard: "18 Mar 2024", email: "sales@lankadairy.lk", phone: "+94 76 543 2109", status: "Inactive" },
  { id: "S-104", name: "Kovil Publications", type: "Books & Calendars", onboard: "22 Mar 2024", email: "kovilpubs@gmail.com", phone: "+94 77 111 2222", status: "Active" },
];
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500 max-w-[1600px] mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <MetricCard title="VENDORS" value="14" sub="all time" />
        <MetricCard title="ACTIVE" value="12" sub="onboarded" />
        <MetricCard title="PENDING" value="2" sub="verification" />
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-[32px] border border-zinc-100 dark:border-zinc-800 shadow-sm overflow-hidden">
        ...
        <div className="px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-50 dark:border-zinc-800">
           <div className="flex items-center gap-3">
              ...
              <span className="px-2 py-0.5 rounded-md bg-orange-50 dark:bg-orange-950/30 text-[10px] font-bold text-orange-600 border border-orange-100 dark:border-orange-800">14 Vendors</span>
           </div>
        ...
        <div className="px-8 py-4 flex flex-col lg:flex-row lg:items-center gap-4 bg-white dark:bg-zinc-900">
           <div className="relative flex-1">
              ...
              <input 
                ...
                placeholder="Search vendor by name, email, or category..."
                value={search}
           ...
           <div className="flex items-center gap-1.5 p-1 bg-zinc-50 dark:bg-zinc-950 rounded-xl border border-zinc-100 dark:border-zinc-800 overflow-x-auto">
              {["All Vendors", "Flowers", "Puja Items", "Maintenance"].map(tab => (
                 <button 
                   key={tab}
        ...
        <div className="overflow-x-auto">
           <table className="w-full text-left">
              <thead className="bg-zinc-50/50 dark:bg-zinc-950 border-y border-zinc-50 dark:border-zinc-800">
                 <tr>
                    <th className="px-8 py-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Vendor ID</th>
                    <th className="px-8 py-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Supplier Name</th>
                    <th className="px-8 py-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Category / Type</th>
                    <th className="px-8 py-4 text-[10px] font-bold text-zinc-400 uppercase tracking-wider">Onboarded</th>
              ...
              <tbody className="divide-y divide-zinc-50 dark:divide-zinc-800">
                 {SUPPLIERS_DATA.map((row) => (
                    <tr key={row.id} className="hover:bg-zinc-50/30 dark:hover:bg-zinc-800/20 transition-colors">
                       ...
                       <td className="px-8 py-5">
                          <span className="px-2.5 py-1 rounded-md bg-emerald-50 dark:bg-emerald-950/30 text-[10px] font-bold text-emerald-600 border border-emerald-100 dark:border-emerald-900">
                             {row.type}
                          </span>
                       </td>
