...
import { redirectToTempleAdminSignin } from "@/lib/temple-admin-login";
...
export function TempleAccountPopover() {
  ...
  const loadProfile = useCallback(async () => {
    ...
    setLoadError(null);
    try {
      const res = await fetch("/api/temple-admin/me", { cache: "no-store" });
  ...
  return (
    <div className="relative" ref={rootRef}>
      <button
        ...
        aria-controls="temple-admin-account-menu"
